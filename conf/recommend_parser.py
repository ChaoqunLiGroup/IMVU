...
def recommend_parse_args():
    ...
    # ===== dataset ===== #
    parser.add_argument("--dataset", nargs="?", default="douban", help="Choose a dataset:[FilmTrust, ]")
    ...
    # ===== model ===== #
    parser.add_argument('--model_name', type=str, default='SimGCL', help='[LightGCN,SGL,NCL,SimGCL,XSimGCL,SSL4Rec...]')
    ...
    parser.add_argument("--save_emb_dir", type=str, default="./embsaved/", help="output directory for model")
