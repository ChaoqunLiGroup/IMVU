...
def attack_parse_args():
    ...
    # ===== Genneral parameters ===== #
    parser.add_argument('--attackCategory', type=str, default="Gray", metavar='N',help='["Black","Gray", "White"]')
    parser.add_argument('--attackModelName', type=str, default="New_U", metavar='N',help='[RandomAttack, BandwagonAttack,FedRecAttack,A_ra,CLeaR ...]')
    ...
    parser.add_argument('--maliciousUserSize', type=float, default="0.05", metavar='N',
