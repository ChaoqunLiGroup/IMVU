...
class ATK():
    ...
    def RecommendTrain(self, attack=None):
        ...
        if attack is None:
            ...
            if not os.path.exists(self.recommendArg.save_emb_dir):
                os.makedirs(self.recommendArg.save_emb_dir)
            if not os.path.exists(self.recommendArg.save_emb_dir + "clean"):
                os.makedirs(self.recommendArg.save_emb_dir + "clean")
            self.recommendModel.save_emb(self.recommendArg.save_emb_dir+ "clean" + "/" + self.recommendModelName + "_" + str(
                                   self.recommendArg.emb_size) + "_"+ str(self.recommendArg.n_layers) + "_" + self.datasetName + ".pt")
        else:
            ...
            if not os.path.exists(self.recommendArg.save_emb_dir):
                os.makedirs(self.recommendArg.save_emb_dir)
            if not os.path.exists(self.recommendArg.save_emb_dir + "poison"):
                os.makedirs(self.recommendArg.save_emb_dir + "poison")
            self.recommendModel.save_emb(self.recommendArg.save_emb_dir+ "poison" + "/" + self.recommendModelName + "_" + self.attackModelName + "_" + str(
                                   self.recommendArg.emb_size) + "_"+ str(self.recommendArg.n_layers) + "_" + self.datasetName + ".pt")
