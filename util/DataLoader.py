...
class DataLoader():
    def __init__(self, args):
        self.training_data = FileIO.load_data_set(args.data_path + args.dataset + args.training_data)
        self.val_data = FileIO.load_data_set(args.data_path + args.dataset + args.val_data)
        ...
        self.id2user = {}
        self.id2item = {}
        self.user_degree = defaultdict(int)
        self.item_degree = defaultdict(int)
    ...
    def cal_userdegree(self):
        # print(self.user_degree)
        for entry in self.training_data:
            user, item, rating = entry
            self.user_degree[user] += 1
        return self.user_degree
    
    def cal_itemdegree(self):
    # print(self.user_degree)
        for entry in self.training_data:
            user, item, rating = entry
